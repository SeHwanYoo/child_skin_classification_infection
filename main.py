    ...
    for skf_num in [5, 10]:
            ...
            for train_idx, valid_idx in skf.split(train_images, train_labels):
                ...
                with mirrored_strategy.scope():
                    ...
                    train_dataset = train_dataset.map(dataset_generator.oversampling).map(dataset_generator.aug1, num_parallel_calls=AUTOTUNE).batch(parameters.num_batch, drop_remainder=True).prefetch(AUTOTUNE)
